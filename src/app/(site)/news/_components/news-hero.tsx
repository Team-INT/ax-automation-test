...
export function NewsHero({ label = "소식", title, description }: NewsHeroProps) {
  return (
    <section className="relative overflow-hidden bg-forest pt-36 pb-24 text-white">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <Image
          src="https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&w=1600&q=75"
          alt=""
          fill
          priority
        ...
        <div
          ...
          style={{
            background: [
              ...
              "radial-gradient(ellipse 70% 60% at 5% 95%, rgba(45,106,79,0.4), transparent)",
            ].join(", "),
          }}
        />
        <div
